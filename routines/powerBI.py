...
if __name__ == '__main__':
    ...
    fat_area_specialty()
    print('fat_area_specialty finalizado')
    fat_great_area()
    print('fat_great_area finalizado')
    dim_area_specialty()
    print('dim_area_specialty finalizado')
    dim_great_area()
    print('dim_great_area finalizado')
    fat_openalex_researcher()
    print('fat_openalex_researcher finalizado')
    researcher_area_leader()
    print('researcher_area_leader finalizado')
    fat_openalex_article()
    print('fat_openalex_article finalizado')
    dim_area_leader()
    print('dim_area_leader finalizado')
    npai()
    print('npai finalizado')
    iapos()
    print('iapos finalizado')
    dim_city()
    print('dim_city finalizado')
    ufmg_researcher()
    print('ufmg_researcher finalizado')
    DimensaoAno()
    print('DimensaoAno finalizado')
    DimensaoTipoProducao()
    print('DimensaoTipoProducao finalizado')
    platform_image()
    print('platform_image finalizado')
    Qualis()
    print('Qualis finalizado')
    dim_departament()
    print('dim_departament finalizado')
    data()
    print('data finalizado')
    cimatec_graduate_program_student()
    print('cimatec_graduate_program_student finalizado')
    graduate_program_student_year_unnest()
    print('graduate_program_student_year_unnest finalizado')
    dim_graduate_program_acronym()
    print('dim_graduate_program_acronym finalizado')
    graduate_program_researcher_year_unnest()
    print('graduate_program_researcher_year_unnest finalizado')
    dim_departament_technician()
    print('dim_departament_technician finalizado')
    dim_departament_researcher()
    print('dim_departament_researcher finalizado')
    fat_group_leaders()
    print('fat_group_leaders finalizado')
    dim_research_group()
    print('dim_research_group finalizado')
    dim_category_level_code()
    print('dim_category_level_code finalizado')
    fat_foment()
    print('fat_foment finalizado')
    fat_production_tecnical_year_novo_csv_db()
    print('fat_production_tecnical_year_novo_csv_db finalizado')
    dim_institution()
    print('dim_institution finalizado')
    researcher_city()
    print('researcher_city finalizado')
    fat_simcc_bibliographic_production()
    print('fat_simcc_bibliographic_production finalizado')
    production_tecnical_year()
    print('production_tecnical_year finalizado')
    researcher()
    print('researcher finalizado')
    article_qualis_year_institution()
    print('article_qualis_year_institution finalizado')
    production_researcher()
    print('production_researcher finalizado')
    article_qualis_year()
    print('article_qualis_year finalizado')
    production_year_distinct()
    print('production_year_distinct finalizado')
    production_year()
    print('production_year finalizado')
    production_coauthors_csv_db()
    print('production_coauthors_csv_db finalizado')
    fat_researcher_ind_prod()
    print('fat_researcher_ind_prod finalizado')
    graduate_program_ind_prod()
    print('graduate_program_ind_prod finalizado')
    researcher_production_novo_csv_db()
    print('researcher_production_novo_csv_db finalizado')
    article_distinct_novo_csv_db()
    print('article_distinct_novo_csv_db finalizado')
    production_distinct_novo_csv_db()
    print('production_distinct_novo_csv_db finalizado')
    cimatec_graduate_program_researcher()
    print('cimatec_graduate_program_researcher finalizado')
    cimatec_graduate_program()
    print('cimatec_graduate_program finalizado')
    dim_research_project()
    print('dim_research_project finalizado')
    fat_research_project_foment()
    print('fat_research_project_foment finalizado')
    dim_bibliographic_production_terms()
    print('dim_bibliographic_production_terms finalizado')
    dim_tecnical_production_terms()
    print('dim_tecnical_production_terms finalizado')
    dim_logs_routine()
    print('dim_logs_routine finalizado')
    fat_logs_routine()
    print('fat_logs_routine finalizado')
    fat_event_organization()
    print('fat_event_organization finalizado')
    fat_participation_events()
    print('fat_participation_events finalizado')
    materialized_vision()
    print('materialized_vision finalizado')
    fat_article_keyword_()
    print('fat_article_keyword_ finalizado')
    dim_article_keyword()
    print('dim_article_keyword finalizado')
    fat_article_co_authorship()
    print('fat_article_co_authorship finalizado')
    fat_keywords_cooccurrences()
    print('fat_keywords_cooccurrences finalizado')
    fat_co_authorship()
    print('fat_co_authorship finalizado')
    dim_tags_csv()
    print('dim_tags_csv finalizado')
    fat_tags_csv()
    print('fat_tags_csv finalizado')
    # _guidance()
    # supervisor()
    # guidance()
    # guidance_per_year()
