...
@pytest.mark.unit
@pytest.mark.asyncio
async def test_chat_ask_researcher_search(mock_llm_provider, mock_embeddings_provider):
    """
...
@pytest.mark.unit
@pytest.mark.asyncio
async def test_chat_ask_no_results_handling(mock_llm_provider, mock_embeddings_provider):
    """
