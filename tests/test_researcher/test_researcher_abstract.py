# tests/routes/test_researcher_abstract.py
...
async def test_term_filter_on_researcher_abstract(client, create_researcher):
    ...
    expected_count = 1
    params = {'term': 'sinergia quântica', 'type': 'ABSTRACT'}
...
async def test_name_filter_on_researcher_name(client, create_researcher):
    """Testa o filtro por termo no nome do pesquisador."""
    # Arrange
    ...
    expected_count = 1
    params = {'name': 'Sabin', 'type': 'ABSTRACT'}
...
async def test_graduate_program_filter_on_abstract_search(
    ...
    expected_count = 1
    params = {'graduate_program': program['name'], 'type': 'ABSTRACT'}
...
async def test_department_filter_on_abstract_search(
    ...
    expected_count = 1
    params = {'departament': department['dep_nom'], 'type': 'ABSTRACT'}
...
async def test_institution_filter_on_abstract_search(
    ...
    expected_count = 1
    params = {'institution': institution['name'], 'type': 'ABSTRACT'}
...
async def test_city_filter_on_abstract_search(
    ...
    expected_count = 1
    params = {'city': city, 'type': 'ABSTRACT'}
...
async def test_area_filter(
    ...
    expected_count = 1
    params = {'area': ';'.join(great_area_), 'type': 'ABSTRACT'}
...
async def test_research_group_filter_by_name_on_abstract_search(
    ...
    expected_count = 1
    params = {'group': research_group['name'], 'type': 'ABSTRACT'}
...
async def test_modality_filter_on_abstract_search(
    ...
    expected_count = 1
    params = {'modality': modality, 'type': 'ABSTRACT'}
...
async def test_researcher_id_filter_on_abstract_search(
    ...
    expected_count = 1
    params = {'researcher_id': target_researcher['id'], 'type': 'ABSTRACT'}
...
async def test_lattes_id_filter_on_abstract_search(client, create_researcher):
    ...
    expected_count = 1
    params = {'lattes_id': lattes_id, 'type': 'ABSTRACT'}
...
async def test_graduation_filter_on_abstract_search(client, create_researcher):
    ...
    expected_count = 1
    params = {'graduation': graduation, 'type': 'ABSTRACT'}
...
async def test_department_id_filter_on_abstract_search(
    ...
    expected_count = 1
    params = {'dep_id': department['dep_id'], 'type': 'ABSTRACT'}
...
async def test_research_group_id_filter_on_abstract_search(
    ...
    expected_count = 1
    params = {'group_id': research_group['id'], 'type': 'ABSTRACT'}
...
async def test_filter_by_star(
    ...
    params = {'star': True, 'type': 'ABSTRACT'}
