...
def test_general_production_metrics_query_researcher_filter():
    query = GeneralProductionMetricsQuery(session=None)
    query._apply_researcher_id_filter('72f9a7d3-1d01-447a-8f4b-0e86976a47a1')
    query.build_sql()

    for key, sql in query._queries.items():
        assert 'researcher_id = :researcher_id' in sql
        assert query.params['researcher_id'] == '72f9a7d3-1d01-447a-8f4b-0e86976a47a1'
